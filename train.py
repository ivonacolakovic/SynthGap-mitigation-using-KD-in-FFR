...
def main(args):
    ...
    cfg.ethnicity = "Indian"
    cfg.out_teacher_baseline='/nas-ctm01/homes/mecaldeira/output/teacher_baseline/'+cfg.ethnicity
    cfg.rec="/nas-ctm01/datasets/public/BIOMETRICS/BalancedFace_embeddings/baseline/teacher_"+cfg.ethnicity
    cfg.output=cfg.out_teacher_baseline

    if cfg.ethnicity=="African":
        cfg.num_classes=7000
    else:
        cfg.num_classes=6999
